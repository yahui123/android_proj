...
import static com.flh.framework.net.FrameworkNetConstants.ADD_COOKIE;
...
public class RetrofitApiBuilder {
    ...
    * 添加连接超时
    * */
    public RetrofitApiBuilder setConnectTimeout(long timeout, TimeUnit unit) {
     ...
     * 添加读取数据超时
     * */
    public RetrofitApiBuilder setReadTimeout(long timeout, TimeUnit unit) {
     ...
     * 添加写数据超时
     * */
    public RetrofitApiBuilder setWriteTimeout(long timeout, TimeUnit unit) {
