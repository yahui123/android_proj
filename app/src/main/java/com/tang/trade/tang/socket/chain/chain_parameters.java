...
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_ACCOUNTS_PER_FEE_SCALE;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_ACCOUNT_FEE_SCALE_BITSHIFTS;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_BLOCK_INTERVAL;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_BURN_PERCENT_OF_FEE;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_CASHBACK_VESTING_PERIOD_SEC;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_CASHBACK_VESTING_THRESHOLD;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_COMMITTEE_PROPOSAL_REVIEW_PERIOD_SEC;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_FEE_LIQUIDATION_THRESHOLD;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_LIFETIME_REFERRER_PERCENT_OF_FEE;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_MAINTENANCE_INTERVAL;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_MAINTENANCE_SKIP_SLOTS;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_MAX_ASSERT_OPCODE;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_MAX_ASSET_FEED_PUBLISHERS;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_MAX_ASSET_WHITELIST_AUTHORITIES;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_MAX_AUTHORITY_MEMBERSHIP;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_MAX_BLOCK_SIZE;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_MAX_COMMITTEE;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_MAX_PROPOSAL_LIFETIME_SEC;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_MAX_TIME_UNTIL_EXPIRATION;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_MAX_TRANSACTION_SIZE;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_MAX_WITNESSES;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_NETWORK_PERCENT_OF_FEE;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_WITNESS_PAY_PER_BLOCK;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_WITNESS_PAY_VESTING_SECONDS;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_DEFAULT_WORKER_BUDGET_PER_DAY;
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_MAX_SIG_CHECK_DEPTH;
