...
public class IndexRegisteredAccountActivity extends BaseActivity {
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                startActivity(new Intent(IndexRegisteredAccountActivity.this, RegisterSuccessfullyActivity.class).putExtra("name", et_username.getText().toString()).putExtra("suggestPrivateKey", suggestPrivateKey));
                finish();
            } else if (msg.what == 2) {
                if (progress < 60) {
    ...
    Runnable runnable = new Runnable() {
        ...
        public void run() {
            ...
            if (TextUtils.isEmpty(userName.trim()) || !userName.matches("^([a-z]{1}[0-9a-z]{5,19})$")) {
                ...
                Toast.makeText(IndexRegisteredAccountActivity.this, getString(R.string.bds_account_note), Toast.LENGTH_LONG).show();
    ...
    protected int getLayoutId() {
        return R.layout.activity_index_registered_account;
    }
        ...
        if (UtilOnclick.isFastClick()) {
            switch (v.getId()) {
                ...
                case R.id.tv_select_node:
                    startActivity(new Intent(this, SelectNodeActivity.class));
                    break;
    ...
    public void initView() {
        ...
        tv_import_wallet.setOnClickListener(this);
...
//                    Log.e("eeeee","注册223"+response.body().getStatus());
                        if (response.body().getStatus().equalsIgnoreCase("success")) {
                            ...
                            if (nRet == 0) {
                                ...
                                btn_confirm.setClickable(true);
                                progressDialog.dismiss();
                                startActivity(new Intent(IndexRegisteredAccountActivity.this, RegisterSuccessfullyActivity.class).putExtra("name", et_username.getText().toString()).putExtra("suggestPrivateKey", suggestPrivateKey).putExtra("suggestPublicKey", suggestPublicKey).putExtra("index", 1));
                                finish();
                            }else {
