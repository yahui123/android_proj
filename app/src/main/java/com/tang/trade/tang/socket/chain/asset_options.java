...
import static com.tang.trade.tang.socket.chain.config.GRAPHENE_MAX_SHARE_SUPPLY;
import static com.tang.trade.tang.socket.chain.types.UIA_ASSET_ISSUER_PERMISSION_MASK;
