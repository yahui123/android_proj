...
//    记录上一次position的位置
    ...
    private int indicatorColor = 0xff00A2F2;
    ...
    private int tabTextColor = 0xFF4d4d4d;
...
//        horizontalPadding = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, horizontalPadding, dm);
    ...
    private void addTextTab(final int position, String title) {
        ...
        if (isBDS == false){
            ...
            if (title.equalsIgnoreCase("BDS") || title.equalsIgnoreCase("BTC") ){
                SpannableString styledText = new SpannableString(title);
                styledText.setSpan(new TextAppearanceSpan(getContext(), R.style.style1), 0, title.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                tab.setText(styledText,TextView.BufferType.SPANNABLE);
            }else{
                SpannableString styledText = new SpannableString("BDS"+title);
                styledText.setSpan(new TextAppearanceSpan(getContext(), R.style.style0), 0, 3, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                styledText.setSpan(new TextAppearanceSpan(getContext(), R.style.style1), 3, new String("BDS"+title).length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                tab.setText(styledText,TextView.BufferType.SPANNABLE);
            }
        }
...
//            tab.setPadding(horizontalPadding, verticalPadding, horizontalPadding, verticalPadding);
            wrapTabLayoutParams.setMargins(20, 0, 20, 0);
...
//                        tab.setAllCaps(true);
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            Log.e("xujun", "lastSelectPosition:=" + lastSelectPosition);
            Log.e("xujun", "selectCurPotition:=" +selectCurPotition);
