package com.tang.trade.tang.zxing.view;
...
public class CaptureView extends View {
    ...
    private static final int POSSIBLE_POINT_ALIVE_MS = 300;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (possiblePoints.size() > 0 && possiblePoints.peek()!=null && current - possiblePoints.peek().foundTime >= POSSIBLE_POINT_ALIVE_MS) {
            possiblePoints.poll();
        }
