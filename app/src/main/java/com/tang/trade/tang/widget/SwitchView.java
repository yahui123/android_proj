...
public class SwitchView extends LinearLayout implements OnClickListener {
	...
	private void changeTextColor() {
		if(isChecked) {
			switch_text_true.setTextColor(underlineColor);
			switch_text_false.setTextColor(indicatorColor);
		} else {
			switch_text_true.setTextColor(indicatorColor);
			switch_text_false.setTextColor(underlineColor);
		}
	}
	...
	public void setTapText(String leftText,String rightText){
		switch_text_true.setText(leftText);
		switch_text_false.setText(rightText);
