...
public class AccRecordAdapter extends BaseAdapter {
    ...
    public AccRecordAdapter(List<RecordResponseModel.DataBean> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(parent.getContext(), R.layout.fragment_record_acc_item, null);

            holder = new ViewHolder();
            holder.tv_free = (TextView) convertView.findViewById(R.id.tv_type);
            holder.tv_user = (TextView) convertView.findViewById(R.id.tv_user);
            holder.tv_count = (TextView) convertView.findViewById(R.id.tv_count);
            holder.tv_type = (TextView) convertView.findViewById(R.id.tv_time);
...
;
        holder.tv_user.setText(list.get(position).getName());
        ...
        if (list.get(position).getStatus().equalsIgnoreCase("0")){
            ...
            if (index.equals("0")){
                holder.tv_status.setText(context.getString(R.string.bds_PendingPaymentFrom));
            }else if (index.equals("1")){
                holder.tv_status.setText(context.getString(R.string.bds_waitmember));
            }
            ...
            if (index.equals("0")){
                ...
                holder.tv_status.setText(context.getString(R.string.bds_confirmtransfer));
            }
        ...
        holder.tv_free.setText(list.get(position).getFree());
    ...
    static class ViewHolder {
        TextView tv_type, tv_count, tv_user,tv_free,tv_status;
    }
