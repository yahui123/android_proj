...
/**
 * Created by dagou on 2017/9/26.
 */

public class SunsungWorkOut {
    // For arrow_left information, see https://code.google.com/p/android/issues/detail?id=5497
    ...
    public static void assistActivity(View viewObserving) {
        new SunsungWorkOut(viewObserving);
    }
    ...
    private SunsungWorkOut(View viewObserving) {
