...
import com.tang.trade.tang.socket.bitlib.crypto.HmacPRNG;
import com.tang.trade.tang.socket.bitlib.crypto.InMemoryPrivateKey;
import com.tang.trade.tang.socket.bitlib.crypto.RandomSource;
import com.tang.trade.tang.socket.bitlib.crypto.SignedMessage;
...
import com.tang.trade.tang.socket.chain.compact_signature;
...
public class private_key {
    ...
    public static private_key generate() {
        try {
            insertProviderAt(new org.spongycastle.jce.provider.BouncyCastleProvider(), 1);
