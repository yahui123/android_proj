...
public class NewDownloadAddressActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        tv_title.setText(getString(R.string.bds_download_address_tiltlt));
        tvNode.setText(getString(R.string.bds_download_address_node));
    ...
    private void acceptantList() {
        AcceptorApi.acceptantHttp(new HashMap<String, String>(), "url_down_app", new JsonCallBack<DownloadAddressModel>(DownloadAddressModel.class) {
            @Override
