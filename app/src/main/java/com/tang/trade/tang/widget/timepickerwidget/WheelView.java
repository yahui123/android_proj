...
package com.tang.trade.tang.widget.timepickerwidget;
...
import com.tang.trade.tang.adapter.timepicker.WheelViewAdapter;
...
//			0xcfffffff, 0x3fffffff };
	private int[] SHADOWS_COLORS = new int[] { 0xefededf2,
			0xcfededf2, 0x3fededf2 };
	...
	private int wheelBackground = R.color.mine_accmanage_text_gray_v2;
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.common_text_blank));
		// 设置线宽
